  ...
  return (
    <>
      <header className="lp-header">
        <img className="logo" src={MooshflixLogo} alt="" />
        <div>
          <select className="lp-header__language-select">
      ...
      <div className="lp-hero-card">
        <div className="lp-hero-card-container">
          <h1 className="lp-hero-card__title">
          ...
          <div>
            ...
            <form>
              <input
                className="lp-hero-card__email-form-input"
      ...
      <div className="lp-ads-plan-card">
        <div className="lp-ads-plan-banner">
          <div>
          ...
          <div className="lp-ads-plan-banner__content">
            <p className="lp-ads-plan-banner__title ">
              The Netflix you love for just $6.99.
            </p>
            <p className="lp-ads-plan-banner__subtitle">
              Get the Standard with ads plan.
            </p>
            <button className="lp-ads-plan-banner__action-btn">
              Learn More
              <svg
